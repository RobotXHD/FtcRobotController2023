...
public class Var {
    ...
    public static double Day_Hhigh = 90, Day_Shigh = 255, Day_Vhigh = 255, Day_Hlow = 20, Day_Slow = 0, Day_Vlow = 0;
    public static double Night_Hhigh = 90, Night_Shigh = 100, Night_Vhigh = 200, Night_Hlow = 30, Night_Slow = 8, Night_Vlow = 100;
