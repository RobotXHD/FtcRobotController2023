...
import static org.firstinspires.ftc.teamcode.VarPipelineRosu.*;
...
public class PipelineRosu extends OpenCvPipeline {
    ...
    public Mat processFrame(Mat input) {
        try {
            ...
            if (RoCV_detectionType == VarPipelineRosu.DetectionTypes.DAY) {
                scalarLowerHSV = new Scalar(RoDay_Hlow, RoDay_Slow, RoDay_Vlow);
                scalarUpperHSV = new Scalar(RoDay_Hhigh, RoDay_Shigh, RoDay_Vhigh);
            }
            else {
                scalarLowerHSV = new Scalar(RoNight_Hlow, RoNight_Slow, RoNight_Vlow);
                scalarUpperHSV = new Scalar(RoNight_Hhigh, RoNight_Shigh, RoNight_Vhigh);
            }
