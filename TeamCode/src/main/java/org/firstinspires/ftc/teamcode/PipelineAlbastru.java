...
import static org.firstinspires.ftc.teamcode.VarPipelineAlbastru.*;
...
public class PipelineAlbastru extends OpenCvPipeline {
    ...
    public Mat processFrame(Mat input) {
        try {
            ...
            if (AlCV_detectionType == VarPipelineAlbastru.DetectionTypes.DAY) {
                scalarLowerHSV = new Scalar(AlDay_Hlow, AlDay_Slow, AlDay_Vlow);
                scalarUpperHSV = new Scalar(AlDay_Hhigh, AlDay_Shigh, AlDay_Vhigh);
            }
            else {
                scalarLowerHSV = new Scalar(AlNight_Hlow, AlNight_Slow, AlNight_Vlow);
                scalarUpperHSV = new Scalar(AlNight_Hhigh, AlNight_Shigh, AlNight_Vhigh);
            }
